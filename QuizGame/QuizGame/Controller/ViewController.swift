...
class ViewController: UIViewController {
    ...
    func updateQuestion(){
        if questionNumber <= allQuestions.list.count - 1{
            ...
            selectAnswer = allQuestions.list[questionNumber].correctAnswer
            
            updateUI()
        }else{
            let alert = UIAlertController(title: "Awsome", message: "End of Quiz. Do you want to start over?", preferredStyle: .alert)
